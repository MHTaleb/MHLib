...
public class DBInstall {
    ...
    private static final void installUsersTables() {
        ...
        String Query
                = "CREATE DATABASE IF NOT EXISTS `"+Properties_Bundel.getString(Properties_Bundel.DataBase)+"`;";
        ...
        String Query4
                ...
                + "	;";
         String Query41
                ="UPDATE `"+Properties_Bundel.getString(Properties_Bundel.DataBase)+"`.`profiles` SET `ID`=0 WHERE  `ID`=3 OR TITRE ='Super Administrateur';";
        String Query5
        ...
        String Query10
                ...
                + "	(0, 'inactive'),"
                + "	(1, 'active');";
        String Query101 ="UPDATE `"+Properties_Bundel.getString(Properties_Bundel.DataBase)+"`.`usersstate` SET `ID`=0 WHERE  `ID`=2 OR TITRE='inactive';";
        ...
        SQLTools.Setup("jdbc:mysql://localhost/"+Properties_Bundel.getString(Properties_Bundel.DataBase)+"","root","");
        System.out.println("using "+Properties_Bundel.getString(Properties_Bundel.DataBase)+"");
